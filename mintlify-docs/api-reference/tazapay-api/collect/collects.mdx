---
title: "Collect"
description: "Collects represent incoming payments to your global collection accounts. A collect is created whenever there is a credit in the collection accounts."
...
```
```json Crypto Collect expandable
{
  "status": "success",
  "message": "",
  "data": {
