---
title: "p24_eur"
description: "Przelewy24 (P24) is a Polish online payment method enabling secure bank transfers and payments directly from local banks. It supports instant transactions and is widely used for e-commerce in Poland. p24_eur is an extension of the Przelewy24 payment method, enabling secure and instant online bank transfers in euros. It caters to cross-border transactions while maintaining the reliability of Polish local bank connections."
---
...
Tazapay uses a payin object to represent your intent to collect a payment from your customer. The payin object tracks state changes from p24 transaction creation to payment completion. Create a payin on your server with an amount, invoice\_currency EUR and a transaction\_description using the create payin API
...
```
{
    ...
    "data": {
        ...
        "cancel_url": "https://mypage.failure",
        "cancelled_at": null,
        "client_token": "bXdT0-BZgRZ1qLRliUdKNxyYdBqr2CXXJIbRqlmSwLM=",
        "confirm": true,
        "created_at": "2025-01-06T08:50:57.914897439Z",
        ...
        "id": "pay_cttpis42ukmk385sb2p0",
        "invoice_currency": "EUR",
        "items": [],
        "latest_payment_attempt": "pat_cttpisc2ukmk385sb2r0",
        "latest_payment_attempt_data": {
            "expires_at": "2025-01-06T08:55:57Z",
            "redirect_url": "https://checkout-sandbox.tazapay.com/single-payment.html?tzid=bXdT0-BZgRZ1qLRliUdKNxyYdBqr2CXXJIbRqlmSwLM=&spid=aHR0cHM6Ly9jaGVja291dC1zYW5kYm94LnRhemFwYXkuY29tL3NpbXVsYXRlL2JYZFQwLUJaZ1JaMXFMUmxpVWRLTnh5WWRCcXIyQ1hYSkliUnFsbVN3TE09L3BheV9jdHRwaXM0MnVrbWszODVzYjJwMC9wMjRfZXVy"
        },
        "metadata": null,
        "object": "payin",
