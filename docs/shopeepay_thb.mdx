---
title: "shopeepay_thb"
description: "A popular mobile wallet and payment service in Thailand deeply integrated within the Shopee e-commerce platform."
---
...
Tazapay uses a `payin` object to represent your intent to collect a payment from your customer. The payin object tracks state changes from transaction creation to payment completion via shopeepay. Create a payin on your server with an amount, invoice\_currency `THB` and a transaction\_description using the [create payin API](https://docs.tazapay.com/reference/create-payin)
