...
| Email        | The customer's email address.                                 | Must be a valid email format. Should include an @ symbol and a domain (e.g., gmail.com). Ensure there are no spaces or invalid characters.                                                                         | [\[email protected\]](/cdn-cgi/l/email-protection#85efeaedebabe1eae0c5e8e0abe6eae8) |
...
| ------------ | ------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------- |
| Tax ID       | The customer's CPF (for individuals) or CNPJ (for businesses) | Must contain only numeric characters (no dashes, dots, or spaces Length: CPF (11 digits), CNPJ (14 digits)                                                                                                         | 34960826312                                                                         |
| Email        | The customer's email address.                                 | Must be a valid email format. Should include an @ symbol and a domain (e.g., gmail.com). Ensure there are no spaces or invalid characters.                                                                         | [\[email protected\]](/cdn-cgi/l/email-protection#8ae0e5e2e4a4eee5efcae7efa4e9e5e7) |
| Phone Number | The customer's phone number in international format           | Must start with a + symbol. Followed by the country code, then the last 2 numbers of the area code (DDD), and finally the phone number. Only numeric characters allowed (no dashes, spaces, or special characters) | +5541985652123                                                                      |
| Random Key   | A unique string used as a PIX key                             | Accept all characters, including alphanumeric, dashes (-), and special characters. Length: No restrictions.                                                                                                        | wea478j-1O6l-03fm-t5gh-4L98er7785m2                                                 |
...
| cpf                | 34960826312                                                                                       |
| cnpj               | 34960826312123                                                                                    |
| email              | [\[email protected\]](/cdn-cgi/l/email-protection#7f19160d0c0b51131e0c0b3f0b1e051e0f1e06511c1012) |
| phone              | +5541985652123                                                                                    |
| random             | abc-123                                                                                           |

***

[Local Payment Network](/docs/local-payment-network)
