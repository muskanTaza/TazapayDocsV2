---
title: "Overview"
description: "A popular mobile wallet and payment service offered by Vietnam Posts and Telecommunications Group (VNPT)."
---
...
Tazapay uses a `payin` object to represent your intent to collect a payment from your customer. The payin object tracks state changes from transaction creation to payment completion via VNPT Pay. Create a payin on your server with an amount, invoice\_currency `VND` and a transaction\_description using the [create payin API](https://docs.tazapay.com/reference/create-payin)
...
<CodeGroup>
  ```bash bash
  {
    ...
    "data": {
      ...
      "cancel_url": "",
      "cancelled_at": null,
      "client_token": "Q2mlTs1IsjjmDKvqhqyzHLkXQy8KdMyoFzmmc5xezJ8=",
      "confirm": true,
      "created_at": "2025-01-23T07:56:49.709190443Z",
      ...
      "id": "pay_cu8vcganbet4snrm0cig",
      "invoice_currency": "VND",
      "items": [],
      "latest_payment_attempt": "pat_cu8vcganbet4snrm0cl0",
      "latest_payment_attempt_data": {
        "expires_at": "2025-01-23T08:01:49Z",
        "redirect_url": "https://checkout-sandbox.tazapay.com/single-payment.html?tzid=Q2mlTs1IsjjmDKvqhqyzHLkXQy8KdMyoFzmmc5xezJ8=&spid=aHR0cHM6Ly9jaGVja291dC1zYW5kYm94LnRhemFwYXkuY29tL3NpbXVsYXRlL1EybWxUczFJc2pqbURLdnFocXl6SExrWFF5OEtkTXlvRnptbWM1eGV6Sjg9L3BheV9jdTh2Y2dhbmJldDRzbnJtMGNpZy92bnB0cGF5X3ZuZA=="
      },
      "metadata": null,
      "object": "payin",
