...
Check the collection account object parameter details here - [Global Collection Account](https://docs.tazapay.com/reference/global-collection-account-object)

***

[Retry Policy](/docs/retry-policy)
