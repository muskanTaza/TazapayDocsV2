...
* **Supported Methods & Currencies:** Tazapay supports receiving funds via:
  ...
  * **SWIFT Network:** For receiving international wire transfers in a wider range of currencies. Supported currencies include: `USD, GBP, EUR, AUD, CAD, SGD, AED, HKD, JPY, KWD, NZD, OMR, QAR, SAR, THB, TRY, ZAR, BGN, BHD, CHF, CZK, DKK, HUF, ILS, KES, NOK, PLN, RON, SEK, UGX, CNH  `
