---
title: "mobile_money_kes"
description: "A revolutionary mobile phone-based money transfer, payment, and financial services system in Kenya."
---
...
Tazapay uses a `payin` object to represent your intent to collect a payment from your customer. The payin object tracks state changes from transaction creation to payment completion via mobile money. Create a payin on your server with an amount, invoice\_currency `KES` and a transaction\_description using the [create payin API](https://docs.tazapay.com/reference/create-payin)
...
<CodeGroup>
  ```bash bash
  {
    ...
    "data": {
      ...
      "cancel_url": "",
      "cancelled_at": null,
      "client_token": "xAACz0xsPYHC1vkfxoVQ3ysQ4EfrdgaqQBoC6f4VbpI=",
      "confirm": true,
      "created_at": "2025-01-23T07:21:48.337684072Z",
      ...
      "id": "pay_cu8us2qnbet4snrlvid0",
      "invoice_currency": "KES",
      "items": [],
      "latest_payment_attempt": "pat_cu8us32nbet4snrlvifg",
      "latest_payment_attempt_data": {
        "expires_at": "2025-01-23T07:26:48Z",
        "redirect_url": "https://checkout-sandbox.tazapay.com/single-payment.html?tzid=xAACz0xsPYHC1vkfxoVQ3ysQ4EfrdgaqQBoC6f4VbpI=&spid=aHR0cHM6Ly9jaGVja291dC1zYW5kYm94LnRhemFwYXkuY29tL3NpbXVsYXRlL3hBQUN6MHhzUFlIQzF2a2Z4b1ZRM3lzUTRFZnJkZ2FxUUJvQzZmNFZicEk9L3BheV9jdTh1czJxbmJldDRzbnJsdmlkMC9tb2JpbGVfbW9uZXlfa2Vz"
      },
      "metadata": null,
      "object": "payin",
...
[MEA (Middle East and Africa)](/docs/mea-middle-east-and-africa)
