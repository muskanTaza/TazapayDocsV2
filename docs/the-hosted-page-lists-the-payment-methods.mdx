---
title: "The hosted page lists the payment methods"
---
...
> Related Link: [Checkout API](https://docs.tazapay.com/reference/create-checkout)
...
[Payment Embed](/docs/iframe-solution)
