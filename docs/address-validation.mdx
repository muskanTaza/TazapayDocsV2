...
| billing_details.address.state       | 4-letter State code (ISO 3166-2), The state names and code can be accessed from [this list for US](https://www.iso.org/obp/ui/#iso:code:3166:US) and [this list for CA](https://en.wikipedia.org/wiki/ISO_3166-2:CA) | US, CA                   |
...
| billing_details.phone.calling_code  | Only codes from [this list](https://en.wikipedia.org/wiki/List_of_country_calling_codes#Zones_3%E2%80%934:_Europe)                                                                                                   | US, CA                   |
