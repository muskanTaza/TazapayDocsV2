---
title: "p24_pln"
description: "Przelewy24 (P24) is a Polish online payment method enabling secure bank transfers and payments directly from local banks. It supports instant transactions and is widely used for e-commerce in Poland."
---
...
Tazapay uses a payin object to represent your intent to collect a payment from your customer. The payin object tracks state changes from p24 transaction creation to payment completion. Create a payin on your server with an amount, invoice\_currency PLN and a transaction\_description using the create payin API
