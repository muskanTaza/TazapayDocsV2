...
description: "Direct Debit in the Philippines allows automatic fund transfers from a customer’s bank account for seamless payments."
---
...
Tazapay uses a payin object to represent your intent to collect a payment from your customer. The payin object tracks state changes from directdebit transaction creation to payment completion. Create a payin on your server with an amount, invoice\_currency PHP and a transaction\_description using the create payin API
...
```
{
    ...
    "data": {
        ...
        "cancel_url": "https://mypage.failure",
        "cancelled_at": null,
        "client_token": "vMivH-C9-yA-AvhDhBD4QugxDXWudk5IsQJlzwxz-PQ=",
        "confirm": true,
        "created_at": "2025-01-07T10:47:31.942393384Z",
        ...
        "id": "pay_ctugcgs2ukmk385taqu0",
        "invoice_currency": "PHP",
        "items": [],
        "latest_payment_attempt": "pat_ctugcgs2ukmk385tar0g",
        "latest_payment_attempt_data": {
            "expires_at": "2025-01-07T10:52:31Z",
            "redirect_url": "https://checkout-sandbox.tazapay.com/single-payment.html?tzid=vMivH-C9-yA-AvhDhBD4QugxDXWudk5IsQJlzwxz-PQ=&spid=aHR0cHM6Ly9jaGVja291dC1zYW5kYm94LnRhemFwYXkuY29tL3NpbXVsYXRlL3ZNaXZILUM5LXlBLUF2aERoQkQ0UXVneERYV3VkazVJc1FKbHp3eHotUFE9L3BheV9jdHVnY2dzMnVrbWszODV0YXF1MC9kaXJlY3RkZWJpdF9waHA="
        },
        "metadata": null,
        "object": "payin",
...
This payment method requests expire after 30 minutes and the customer cannot pay once the request has expired. After expiration, the status of the payin changes to `requires_payment_method.` At this point, you can confirm the payin with another payment method or cancel.
