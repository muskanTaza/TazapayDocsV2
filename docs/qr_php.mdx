---
title: "qr_php"
description: "QR_PHP enables fast and secure payments in the Philippines using QR codes, allowing customers to scan and pay directly from their mobile wallets or banking apps."
---
...
Tazapay uses a payin object to represent your intent to collect a payment from your customer. The payin object tracks state changes from QR transaction creation to payment completion. Create a payin on your server with an amount, invoice\_currency PHP and a transaction\_description using the create payin API
...
[bank\_push\_php](/docs/bank_push_php)
