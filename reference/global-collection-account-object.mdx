...
| payment\_method\_type   | enum              | Payment Method Type used for the account. Refer [List](https://docs.tazapay.com/update/docs/collection-accounts-payment-method-type#/)                                                                                                                      |
