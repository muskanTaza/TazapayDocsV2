...
- **Step 1A:** Creating a beneficiary using the [Create Beneficiary endpoint](/reference/create-beneficiary)
- **Step 1B:** Initiating a payout using the [Create Payout endpoint](/reference/create-payout)
...
Create a payout on your server using Tazapay's [payout API](/reference/create-payout) with the following information:
