...
For a detailed walkthrough of payout reversals, reconciliation, and merchant workflows, see the [**Payout Reversals** guide](https://tazapay-58ae360f.mintlify.app/Guides/payouts/reversals/overview).
...
Comprehensive [reason codes](https://tazapay-58ae360f.mintlify.app/API-Reference/appendix/payout-reversal-reasons) have been introduced for payout reversals to help identify the exact cause of a reversal.

## Relevant Links

* [**GET Payout**](https://tazapay-58ae360f.mintlify.app/API-Reference/tazapay-api/payout/fetch-payout)
* [**Payout Webhooks**](https://tazapay-58ae360f.mintlify.app/API-Reference/tazapay-api/payout/webhook-events)
* [**GET Balance Transaction**](https://tazapay-58ae360f.mintlify.app/API-Reference/tazapay-api/balance-transaction/fetch-balance-transaction)