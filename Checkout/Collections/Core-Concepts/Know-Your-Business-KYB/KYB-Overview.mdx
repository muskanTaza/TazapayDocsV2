...
title: "KYB Overview"
---
KYB helps Tazapay understand more about your business.
...
<Callout icon="📘" theme="info">
  To learn more about why KYB is required, feel free to check out our <a href="https://support.tazapay.com/why-is-it-important-to-complete-my-kyc-kyb-process" target="_blank">FAQ</a>.
</Callout>

You will be prompted to complete your KYB as soon as you create an account (or add a business) on Tazapay.

<Image align="center" border={true} src="https://files.readme.io/7e80f90-Screenshot_2023-08-14_at_4.47.35_PM.png" className="border" />
