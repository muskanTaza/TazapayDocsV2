...
- **Step 1A:** Creating a beneficiary using the [Create Beneficiary endpoint](/API-Reference/tazapay-api/beneficiary/create-beneficiary)
- **Step 1B:** Initiating a payout using the [Create Payout endpoint](/API-Reference/tazapay-api/payout/create-payout)
...
Create a payout on your server using Tazapay's [payout API](/API-Reference/tazapay-api/payout/create-payout) with the following information:
