...
* Beneficiary Details
  ...
  * Destination Details
    * PIX key type
    * PIX key
* [Reason for Payout](https://tazapay-58ae360f.mintlify.app/Global-Money-Movement/payouts/purpose)
...
* Step 1A: Creating a beneficiary using the [Create Beneficiary endpoint](https://tazapay-58ae360f.mintlify.app/API-Reference/tazapay-api/beneficiary/create-beneficiary)
* Step 1B: Initiating a payout using the [Create Payout endpoint](https://tazapay-58ae360f.mintlify.app/API-Reference/tazapay-api/payout/create-payout)
...
Create a payout on your server using Tazapay’s [payout API](https://tazapay-58ae360f.mintlify.app/API-Reference/tazapay-api/payout/create-payout) with the following information:
...
> Tazapay delivers [webhooks](https://tazapay-58ae360f.mintlify.app/API-Reference/api-overview/webhooks) to your registered endpoint notifying you of any event of interest for the payout.
