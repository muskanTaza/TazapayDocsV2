...
---
Tazapay offers flexible integration options to cater to your business needs and technical capabilities. You can either redirect to a `Tazapay Hosted Page` or build a `Custom Native Integration`. Tazapay also provides various [no-code](https://tazapay-58ae360f.mintlify.app/Cards-and-LPMs/Collections/Build-a-Payment-Integration/No-Code-Options) payment options to help you get started quickly.
...
| _Integration Guide_                    | [Click here](https://tazapay-58ae360f.mintlify.app/Cards-and-LPMs/Collections/Build-a-Payment-Integration/Tazapay-Hosted-Options/List-the-payment-methods-on-your-own-page)                 | [Click here](https://tazapay-58ae360f.mintlify.app/Cards-and-LPMs/Collections/Build-a-Payment-Integration/Tazapay-Hosted-Options/The-hosted-page-lists-the-payment-methods) | [Click here](https://tazapay-58ae360f.mintlify.app/Cards-and-LPMs/Collections/Build-a-Payment-Integration/Native-Custom-Integration)                                                |
