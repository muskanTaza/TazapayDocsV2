...
- Step 1A: Creating a beneficiary using the [<u>Create Beneficiary endpoint</u>](https://docs.tazapay.com/reference/create-beneficiary)
- Step 1B: Initiating a payout using the [<u>Create Payout endpoint</u>](https://docs.tazapay.com/reference/create-payout)
...
Create a payout on your server using Tazapay’s [<u>payout API</u>](https://docs.tazapay.com/reference/create-payout) with the following information:
