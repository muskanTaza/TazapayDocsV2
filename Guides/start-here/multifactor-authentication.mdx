...
* Use [role-based access](https://docs.tazapay.com/update/docs/managing-your-team): add teammates via Settings > Manage team > Invite Teammate so each user has independent MFA.
