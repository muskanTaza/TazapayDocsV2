...
- Use [<u>role-based access</u>](https://docs.tazapay.com/update/docs/managing-your-team): add teammates via Settings \> Manage team \> Invite Teammate so each user has independent MFA.

# **Support**

If you lose access to all MFA methods and recovery codes, contact [<u>support@tazapay.com</u>](mailto:support@tazapay.com). Identity verification will be required.